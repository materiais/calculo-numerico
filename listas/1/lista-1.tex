...
\item \calc Seja $f(x) = (x^2 - 4)(x - 8)$. Determine o menor valor de $n$ tal que a aproximação $x_n$ obtida pelo método da bisseção tenha um erro relativo percentual menor do que 1\% sendo:
\begin{multicols}{2}
\begin{enumerate}
\item $[a_0, b_0] = [1, 4]$
\item $[a_0, b_0] = [6, 9]$
