...
\item Obtenha uma solução aproximada do sistema anterior, efetuando 2 etapas do método de Jacobi ou de Gauss-Seidel, usando $x^{(0)} = (0, 0, 0, 0)$ como aproximação inicial.
\end{enumerate}
...
x_1^{(k)} \\ x_2^{(k)}
\end{bmatrix} = \fixme$ (solução exata: $x_1 = -1$ e $x_2 = 1$)
\end{enumerate}
